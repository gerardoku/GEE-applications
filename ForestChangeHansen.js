...
var locationDict = {
  'Alto Mayo': {lon: -77.5967, lat: -5.9333, zoom: 10},
  'Karipuna': {lon: -64.4995, lat: -9.8594, zoom: 11},
  'Frontera Agrícola': {lon: -74.4986, lat: 1.3128, zoom: 9}
};
...
// Center the map
var defaultLocation = locationDict['Alto Mayo'];
mapPanel.setCenter(
